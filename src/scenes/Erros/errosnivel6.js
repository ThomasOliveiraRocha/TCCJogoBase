export default class errosnivel6 extends Phaser.Scene {
    constructor() {
        super('errosnivel6');
    }
    ...
    create() {
        ...
        this.add.text(centerX, 20, 'Nível 6: Identifique os Erros', {
            fontFamily: 'VT323',
            fontSize: '26px',
            fill: '#003366',
            fontStyle: 'bold',
        ...
        const errorExplanations = {
            "estratégia": "A troca de número (singular/plural) ajuda o atacante a mascarar a falta de precisão, típica em tentativas genéricas de phishing.",
            "colaboraçao": "A ausência de acentos ou cedilhas é um indicativo claro de e-mails fraudulentos, geralmente enviados por bots ou tradutores ruins.",
            "joão@emailcom": "Domínios inválidos são comuns em tentativas de spoofing — o e-mail tenta parecer legítimo, mas falha em detalhes técnicos.",
            "Solicitacão": "A má acentuação, mesmo em palavras formais, sugere descuido proposital para filtrar apenas alvos mais vulneráveis a golpes.",
            "apoia": "Erros de conjugação verbais sinalizam que o texto pode ter sido adaptado automaticamente e carece de revisão humana.",
            "11.45": "Formato de hora incorreto pode ser usado para simular informalidade ou regionalismo e assim contornar filtros anti-spam.",
            "maio": "O uso de minúsculas em nomes de meses em contextos formais é uma técnica sutil para tornar o texto menos corporativo e mais persuasivo.",
        };
        ...
        const drawEmailHeader = (x, y, isIncorrect = false) => {
            ...
            const headerLines = isIncorrect
                ? [
                    'De: João <joão@emailcom>',
                    'Assunto: Solicitacão de apoia urgente',
                    'Data: 12 de maio, 11.45'
                ]
                : [
                    'De: João <joao@email.com>',
                    'Assunto: Solicitação de apoio urgente',
                    'Data: 12 de Maio, 11:45'
                ];
...
Informamos que os relatórios foram enviados ao setor e já foram analisados pela equipe técnica. A revisão criteriosa dos dados foi fundamental para a elaboração das próximas estratégias.

É essencial que todos os departamentos estejam cientes das alterações propostas, para que as mudanças ocorram de forma harmônica e coordenada.

Solicitamos que cada responsável revise o documento correspondente à sua área e envie um parecer até o final da semana.
...
Informamos que os relatórios foram enviados ao setor e já foram analisados pela equipe técnica. A revisão criteriosa dos dados foi fundamental para a elaboração das próximas estratégia.

É essencial que todos os departamentos estejam cientes das alterações propostas, para que as mudanças ocorram de forma harmônica e coordenada.

Solicitamos que cada responsável revise o documento correspondente à sua área e envie um parecer até o final da semana.

Agradecemos pela colaboraçao.
`;
